    ...
    public class SeedEvent : IEntityTypeConfiguration<Event>
    {
        public void Configure(EntityTypeBuilder<Event> entity)
        {
            entity.HasData(
                ...
                new Event { EventId = 7, Name = "Develop Brighton 2022", Date = new DateTime(2022, 12, 24), Description = "Develop Brighton is the only event in the UK that brings the entire game-making industry together - from global superstars to micro indies, to learn from each other, share ideas and experiences, network and do business in a friendly and inclusive environment. ", Duration = "12 hours" },
