...
namespace GameStore.Areas.Admin.Controllers
{
    ...
    [Area("Admin")]
    public class AdminMerchandiseController : Controller
    {
        ...
        public AdminMerchandiseController(UserManager<User> userMngr, SignInManager<User> signInMngr, StoreContext storeContext, IRepository<Merchandise> rep)
        {
